...
void Shader::CompileShader(const char* vertexCode, const char* fragmentCode)
{
    ...
    // AQUI cambiamos el nombre del uniform: ahora es "uOffset"
    uniformTextureOffset = glGetUniformLocation(shaderID, "uOffset");
    // NUEVO
    uniformTextureSubSize = glGetUniformLocation(shaderID, "uSubSize");
...
GLuint Shader::getOffsetLocation() { return uniformTextureOffset; }

// NUEVO getter
GLuint Shader::getSubSizeLocation() { return uniformTextureSubSize; }
